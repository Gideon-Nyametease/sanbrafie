...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { description: @tour.description, end_date: @tour.end_date, start_date: @tour.start_date, title: @tour.title, tour_id: @tour.tour_id } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { description: @tour.description, end_date: @tour.end_date, start_date: @tour.start_date, title: @tour.title, tour_id: @tour.tour_id } }
